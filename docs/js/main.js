...
jQuery(document).ready(function ($) {
	...
	// 		$('input[name=livingWithPartner').change(function () {
	// 			if ($('input[name=livingWithPartner]:checked').val() === 'yes') {
	// 				localStorage.removeItem('livingWithPartner');
	// 				localStorage.setItem('livingWithPartner', 'yes');
	// 			} else {
	// 				localStorage.removeItem('livingWithPartner');
	// 				localStorage.setItem('livingWithPartner', 'no');
	// 			}
	// 		});
